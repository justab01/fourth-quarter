...
export const SPORT_CATEGORIES: SportCategory[] = [
  {
    ...
    tagline: "NBA · WNBA · NCAA · Summer League",
    leagues: [
      { key: "NBA", label: "NBA" },
      { key: "NBA_SUMMER_LEAGUE", label: "Summer League" },
      { key: "WNBA", label: "WNBA" },
...
const SPORT_ALIASES: Record<string, string> = {
  ...
  "vegas summer league": "basketball",
  "california-classic": "basketball",
  "california classic": "basketball",
  "salt-lake-summer-league": "basketball",
  "salt lake summer league": "basketball",
  nbaslv: "basketball",
  nbaslc: "basketball",
  nbaslu: "basketball",
